...
namespace Pittig.Areas.Customer.Controllers
{
    [Area("Customer")]
    public class OrderController : Controller
    {
        ...
        public async Task<IActionResult> OrderReady(int OrderId)
        {
            ...
            await _emailSender.SendEmailAsync(_db.Users.Where(u => u.Id == orderHeader.UserId).FirstOrDefault().Email, "Pittig - Bestelling klaar voor ophaling " + orderHeader.Id.ToString(), "Bestelling is klaar voor ophaling.");
        ...
        public async Task<IActionResult> OrderCancel(int OrderId)
        {
            ...
            await _db.SaveChangesAsync();
            await _emailSender.SendEmailAsync(_db.Users.Where(u => u.Id == orderHeader.UserId).FirstOrDefault().Email, "Pittig - Order Cancelled " + orderHeader.Id.ToString(), "Order has been cancelled successfully.");
        ...
        public async Task<IActionResult> OrderPickupPost(int orderId)
        {
            ...
            await _db.SaveChangesAsync();
            await _emailSender.SendEmailAsync(_db.Users.Where(u => u.Id == orderHeader.UserId).FirstOrDefault().Email, "Pittig - Order Completed " + orderHeader.Id.ToString(), "Order has been completed successfully.");
